...
Gaussian. The power law behaviour is only seen when the maximum angle is
...
to the R11 sample. A good fit is achieved with similar values to
the intrinsic gaussian than those used by R11.
