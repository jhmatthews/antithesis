...
BAL outflows (see section~\ref{sec:balqsos}). Here, I use observational 
...
The models are computed for an Eddington fraction of $0.2$ and assume a radiative efficiency of 0.1. 
...
\cite{morabito2014}, and would imply that BALQSOs should have significantly
...
\begin{equation}
J_{\mathrm{thick}} \approx \cos \theta~S_L~\Delta \nu~\sqrt{8 \ln \tau_0},
\end{equation}
