...
High-ionization BAL quasars (HiBALs) show
...
approximately $10\%$ of BALQSOs show absorption
...
the ionization physics in a complex geometry and radiation field.
...
% width. 
Here, $W$ is the dilution factor, $k$, $\alpha$ and $\delta$ are parameters
with best-fit 
