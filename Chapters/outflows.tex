...
have been measured in at least 
...
\end{equation}
amd $t$ is the dimensionless optical depth, given by
\begin{equation}
...
may affect the ionization state of the flow and possibly inferred
mass-loss rates.
...
\end{equation}
The first term can then be thought of as a magnetic {\em tension}
...
accretion disc, and the wind is driven by magnetic tension as the
