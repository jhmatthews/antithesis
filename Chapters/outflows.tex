...
a partially ionized plasma. The most common way to parameterise the cumulative
effect of lines on the radiation force is via the {\em force multiplier}, $M(t)$,
which modifies the equation for the radiation force to become
\begin{equation}
\label{eq:force_multiplier}
\vec{F}_{rad} = \frac{\sigma_e }{c} M(t)
\end{equation}
