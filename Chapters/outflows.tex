...
dense substructures (clumps) in their flows. Such lumpiness has been invoked
...
via the ionization parameter, given by \citep[e.g.][]{reynolds1995}
\begin{equation}
...
not necessarily required to drive such an outflow. Intriguingly, this means that 
