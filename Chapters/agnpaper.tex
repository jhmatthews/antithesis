...
In a recent study, \cite[hereafter Y16]{yong2016} used the SV93 wind prescription
...
and the Y16 predictions. Y16 designed two models using the SV93 prescription, 
in order to mimic the MCGV95 and \cite{elvis2000} models described in
section~\ref{sec:wind_models}. 
...
At `quasar-like' angles, the values from the model presented here 
