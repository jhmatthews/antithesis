...
In the earlier chapters we examined the evidence for accretion disc
winds in quasars and luminous AGN, and saw how they may be responsible
...
Here, we aim to test that picture using \py, with
the specific aim of determining whether it is possible to simulate the properties of 
the spectra of AGN, including BALQSOs, 
...
Here we attempt to address both of these issues, by
introducing clumping into our model and a more complete
treatment of H and He into our radiative transfer calculations.
...
we dispense with the ML93 modified Saha approach and fully solve the ionization
...
Finally, we summarise our findings in section~\ref{sec:qso_conclusions}.
...
of scale and density ranges in the model we also show $n_e$ in the wind
...
\begin{figure*}
\centering
\includegraphics[width=1.0\textwidth]{figures/06-agnpaper/fig5.png}
\caption
...
\begin{figure*}
\centering
\includegraphics[width=1.0\textwidth]{figures/06-agnpaper/fig8.png}
\caption
...
the measurement, and we compared to \ha\ rather than \hb\ due to the
