...
can match the line EWs fairly well at low inclinations, they will then
...
as described in section~\ref{sec:wind_models}. 
...
BH mass estimates, and suggest that disc wind models produce similar behaviour in 
$f_{FWHM}$ to disc-shaped BLR models.
