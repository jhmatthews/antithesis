...
rate. Starred quantities mean they are evaluated at the stated temperature but 
in local thermodynamic equilibrium, following \cite{mihalas1982}. 
}
...
\label{eq:rte_solution}
\end{equation}
It becomes useful at this stage
...
disc winds the densities can be very high and higher $Z$ ions must be 
included 
...
%%\sum_{bfjumps} \alpha_{sp} n_e n_{\kappa}
\end{equation}
This convergence criterion could doubtless be improved, but is nonetheless
