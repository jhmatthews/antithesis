...
$\kappa$, are
\begin{equation}
{\cal R}_{jk \kappa}= n_l (\gamma_{l\kappa} - \alpha^{st}_{\kappa l})  + q_{l \kappa} n_l n_e.
\end{equation}
Here, $q_{l \kappa}$ is the collisional ionization rate coefficient, 
$\gamma_{l\kappa}$ is the photoionization rate
from $l \rightarrow \kappa$ and $\alpha^{st}_{\kappa l}$ is the stimulated recombination
...
\begin{equation}
q_{l\kappa} = 1.55 \times 10^{-13} n_e~\bar{g}_{i}~\sigma_{l\kappa} (\nu_0)~
\frac{h \nu_0}{k T_e^{3/2}}
\exp \left( \frac{- h \nu_{ul}}{k T_e} \right),
\label{eq:vanregemorterw}
\end{equation}
...
\begin{equation}
\gamma_{l\kappa} = \frac{1}{V} \sum_i^{photons} 
\frac{w_i~\sigma_{l\kappa}({\nu})}{h \nu}~\Delta s
\end{equation}
and for the stimulated recombination rate is
\begin{equation}
\alpha_{l\kappa}^{st} = \Phi^*_{l\kappa}
...
\begin{equation}
\gamma^E = \frac{1}{V} \sum_i^{photons} \frac{w_i~\sigma_{\nu_0}}{h \nu}~\Delta s 
\end{equation}
...
\begin{equation}
\alpha_{l\kappa}^{st,E} = \Phi^*_{l\kappa}
\frac{1}{V} \sum_i^{photons} 
\frac{w_i~\sigma_{l\kappa}({\nu})}{h \nu}
~\exp(-h\nu/kT_e)~\Delta s
\end{equation}
