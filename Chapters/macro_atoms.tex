...
from LTE.
His `macro-atom'\index{Macro-atoms} scheme allows for all possible transition paths from a given level,
...
\end{equation}
The corresponding jumping probabilities\index{Macro-atoms!transition probabilities}, 
