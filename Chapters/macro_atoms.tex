...
\cite[][hereafter L02, L03]{lucy2002, lucy2003}
...
\begin{equation}
\gamma^E_{j\kappa} = \frac{1}{V} \sum_i^{photons} 
...
\begin{equation}
\cc_{bf} = \sum_{j\kappa}^{bfjumps} (\alpha^E_{\kappa j} - \alpha_{\kappa j}) n_e n_{\kappa}h\nu_{\kappa j} V,
\end{equation}
...
\begin{equation}
\hh_{bf} = \sum_{j\kappa}^{bfjumps} (\gamma^E_{\kappa j} - \gamma_{\kappa j} - \alpha^{st,E}_{\kappa j} + \alpha^{st}_{\kappa j}) n_j h \nu_{\kappa j} V
\end{equation}
...
\begin{equation}
\hh_{bb} = \sum_{ju}^{lines} q_{uj} n_u n_e h \nu_{uj} V,
\end{equation}


\begin{equation}
\cc_{bb} = \sum_{ju}^{lines} q_{ju} n_j n_e h \nu_{uj} V.
\end{equation}
...
\begin{equation}
\hh_{ff} = \sum_i^{photons} w_i \kappa_{ff} \Delta s.
\end{equation}
