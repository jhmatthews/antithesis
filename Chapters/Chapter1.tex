...
\index{BALs}
seen in high-state CVs \citep{heap1978,greensteinoke1982,cordova1982}\index{Cataclysmic Variables}
...
\index{ultra-fast outflows}\index{BALQSOs}\index{BALs}
...
and applied to quasars and AGN \citep[e.g.][]{higginbottom2013}.\index{quasar} 
...
\citep[see the `CV bible', ][]{warnerbook}.\index{cataclysmic variable} 
...
% \citep[see Fig.~\ref{fig:agn_templates}, and][for a review]{falomo2014},
...
\index{BLR}\index{AGN!unification}\index{emission line}
...
and other accreting objects.\index{Occam's razor}\index{Occam's quasar}\index{disc wind}
