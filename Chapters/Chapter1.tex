...
approximately in terms of the mass ratio and separation of the system. A goodapproximation
...
section~\ref{sec:disc_continuum} (Done, private communication; 
...
from theoretical predictions. This can be seen clearly in figure~\ref{fig:agn_templates},
