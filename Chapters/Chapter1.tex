...
\label{sec:bl_isco}
In equation~\ref{eq:ldisc}, I showed that $L_{\mathrm{disc}} = 1/2~L_{\mathrm{acc}}$. 
...
$T_{\mathrm{eff}} (R)$, and the specific intensity through the emitting surface
