...
Broadly speaking, they can be classified according to the 
...
magnetic field inside the Alfven radius (REF). 
...
% In non-magnetic systems th accretion is mediated by a Keplerian disc
...
Since Antonucci \& Miller's seminal study, 
...
\subsection{The Big Blue Blump in AGN}
