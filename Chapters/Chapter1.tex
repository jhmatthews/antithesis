...
tend to appear in specific accretion states \citep{fender2001,kordingDNjet2008}, implying an intrinsic connection to the 
...
may expel stellar material from the donor, allowing some of it to flow 
...
\frac{GM_2}{| \vec{r} - \vec{r}_2 |} - 1/2 (\omega \wedge \vec{r})^2,
\label{eq:roche}
\end{equation} 
where $\omega$ is the angular velocity of the binary and is a vector normal to
the orbital plane. This potential is plotted in figure~? for a mass ratio, 
$q = M_2 / M_1$ of 0.25.
...
\subsection{Observational Appearance}
...
NLs are therefore one of the best `laboratories' for studying steady-state
accretion discs and testing theoretical models for accretion.
NLs generally exhibit a series of strong emission lines 
