...
thesis is focused on the accretion disk winds that are seen in both
...
In the accreting white dwarf setting, the presence of disk winds has
...
constructs a simple model of disk winds in quasars that is capable of
explaining both the absorption and emission signatures seen in these
systems. This is a crucial result that supports a disk-wind based
...
arise in a standard, geometrically thin, optically thick accretion disk,
