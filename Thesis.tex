...
In this thesis I use the stet-of-the-art Monte Carlo radiative transfer (MCRT) code, 
...
developed by Leon Lucy. First, I apply them to the optical spectra of CVs. 
...
\dedicatory{Dedicated to my family. Thanks for being awesome.\ldots}
