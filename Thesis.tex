...
In this thesis, I use a state-of-the-art Monte Carlo radiative transfer code, 
...
strong emission in \ha, \heiiopt\ and a series of He~\textsc{i} lines. 
The model shows the observed trends with inclination and in some cases 
produces sufficient recombination continuum emission to fill in the Balmer jump. 
...
properties and the wind produces strong line emission at low inclinations. 
Despite these successes, the model cannot reproduce all emission lines seen in 
quasar spectra with the correct equivalent width (EW) ratios, and I find a strong 
angular dependence of EW.
